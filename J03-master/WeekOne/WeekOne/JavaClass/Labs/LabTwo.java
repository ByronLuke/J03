...
public class LabTwo {
    ...
    public static void main(String[] args) {
        ...
        // Question 5
        /*
         * //Write a method to prompt the user for a letter of the alphabet and display
         * it's ascii value
         * public static void main(String[] args) {
         * //Rounding a number
         * Scanner scanner = new Scanner(System.in);
        ...
        // Question 6
        /*
         * //Write a method to prompt the user for a double then display the value as a
         * whole number.
         ...
         * System.out.println("You entered " + number + ", the new value is " +
         * wholeNum);
         */
        // Question 7
        /*
         * //Write a method to prompt the user for 4 digits representing a year. Then
