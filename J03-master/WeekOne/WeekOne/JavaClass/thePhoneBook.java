...
public class thePhoneBook {
    ...
    public void removeContactByName(thePhoneBook phoneBook) {
    ...
    public void removeContactByNumber(thePhoneBook phoneBook) {
        System.out.print("What is the number of the contact you would like to remove:");
        Scanner scanner = new Scanner(System.in);
        long removeByNumber = scanner.nextLong();
        for (contact person : phoneBook.contactList) {
            if (removeByNumber == person.getPhoneNumber()) {
                phoneBook.contactList.remove(person);
            } else {
    ...
    public void searchContactByNumber(thePhoneBook phoneBook) {

        System.out.print("Enter phone number: ");
        Scanner scanner = new Scanner(System.in);
        long searchByNumber = scanner.nextLong();
        adress Adress = new adress();
        for (contact person : phoneBook.contactList) {
            if (searchByNumber == person.getPhoneNumber()) {
                printContact();
            } else {
                System.out.println("Contact doesn't exist :( ");
            }
